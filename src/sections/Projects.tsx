...
export const ProjectsSection = () => {
  return(
    ...
    <div className={"container"}>
      ...
      <p className={"text-center text-white/60 mt-4 md:text-lg max-w-md mx-auto lg:text-xl"}>See how i Transformed concepts into real</p>
      <div className={"flex flex-col mt-10 md:mt-20 gap-20"}>
        {portfolioProjects.map((project) => (
            <div key={project.title} className={"bg-gray-800 " +
                "rounded-3xl z-0 overflow-hidden relative after:content-[''] " +
                "after:absolute after:inset-0 after:z-10 after:outline-2 " +
                "after:outline after:-outline-offset-2 after:rounded-3xl after:outline-white/20 px-8 pt-8 after:pointer-events-none md:pt-12 md:px-10 lg:pt-16 lg:px-20" }>
