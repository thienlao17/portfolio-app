          ...
          <div className="container">
              <div className="flex flex-col items-center ">
                  ...
                  <div
                      ...
                      <div className="text-sm font-medium">Готов к новым проектам!</div>
                  </div>
              </div>
              <div className="max-w-lg mx-auto">
                  <h1 className="font-serif text-3xl md:text-5xl text-center mt-8 tracking-wide">Building Exceptional
                      User Experiences</h1>
                  <p className={"mt-4 text-center text-white/60 md:text-lg"}>I specialize in transforming designs into
                      functional, high-performing web apps, Let's discuss your next project.</p>
              </div>
